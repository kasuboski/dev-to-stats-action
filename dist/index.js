...
exports.aggregateCounts = exports.exportStats = exports.getArticleStats = void 0;
...
function exportStats(data, outFile) {
    return __awaiter(this, void 0, void 0, function* () {
        const output = JSON.stringify(data);
        yield io_1.mkdirP(path_1.dirname(outFile));
        yield fs_1.promises.writeFile(outFile, output, 'utf8');
    });
}
exports.exportStats = exportStats;
function aggregateCounts(articles) {
...
const dev_to_1 = __webpack_require__(949);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const stats = yield dev_to_1.getArticleStats(apiKey);
            core.debug(JSON.stringify(stats));
            core.info('Writing stats...');
            yield dev_to_1.exportStats(stats, outFile);
        }
        catch (error) {
